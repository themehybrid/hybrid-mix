...
The code for the this project is handled via its [GitHub Repository](https://github.com/themehybrid/hybrid-mix).  You can open tickets, create patches, and send pull requests there.
